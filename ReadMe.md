...
### Observed Trend 1: 
All schools have a 100% passing rate on reading, but the passing rate of math is lower, Bailey High, Figueroa High, Ford High, Hernandez High, Huang High, Johnson High and Rodriguez High are schools that have the relatively low passing rate of math among all the schools

### Observed Trend 2: 
Small and Medium size school tend to have higher overall passing rate than Large size ones do

### Observed Trend 3: 
Based upon the data given, charter schools tend to have higher overall passing rate than district schools do
